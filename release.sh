...
curl -i -X POST https://api.github.com/repos/hovox/downloading-file-example/releases?access_token=e1e1e1e80f3c414f8c45256217db7c16b0b4901c -d "$params" > /tmp/result.txt;
